...
function enqueue_my_styles()
{
    ...
    wp_enqueue_style('hamburger-css', $uri . '/assets/css/components/hamburger.css');
    ...
    wp_enqueue_style('mobile-nav-css', $uri . '/assets/css/components/mobile-nav.css');
    wp_enqueue_style('header-css', $uri . '/assets/css/components/header.css');
    ...
    if ($needs_symptoms_slider) {
        ...
        wp_enqueue_style('symptoms-section-css', $uri . '/assets/css/components/symptoms-section.css');
    }
